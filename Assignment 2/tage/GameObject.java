...
public class GameObject
{
	...
	private Matrix4f oldRotation, rotAroundAvatarRight, newRotation, rotAroundAvatarUp, rotAroundAvatarCenter;
    private Vector3f rightAxis, upAxis, rollAxis, oldPosition, newPosition;
	...
	public void yaw(float scalar, MyGame game){
        ...
        oldRotation.transformDirection(upAxis); 
	...
	public void pitch(float scalar, MyGame game) {
    	oldRotation = new Matrix4f(this.getLocalRotation()); 
       	rightAxis = new Vector3f(1f, 0f, 0f); 
        oldRotation.transformDirection(rightAxis); 
        rotAroundAvatarRight = new Matrix4f().rotation(scalar, rightAxis);
